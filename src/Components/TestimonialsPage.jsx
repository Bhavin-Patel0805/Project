    ...
    return(
        <section className={"py-12 bg-white"}>
            <div className={"container mx-auto px-6"}>
                <h2 className={"text-3xl md:text-4xl text-center font-extralight text-gray-900 tracking-wide mb-10"}
                    style={{
                ...
                <div 
                    ref={scroller} 
                    className={"flex gap-8 overflow-x-auto xl:overflow-x-container pb-6 px-2 md:px-6  snap-x snap-mandatory cursor-grab"}
                    ...
                    >
                        {cards.map((c)=>(
                            <article key={c.id} className={"snap-center flex-shrink-2 min-w-[92%] md:min-w-[48%] lg:min-w-[49%] bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden flex flex-col lg:flex-row"}>
                            ...
                            <div className={"w-full lg:w-7/12 p-8 flex flex-col justify-between"}>
                                <div>
                                    <h3 className={"text-lg md:text-xl font-bold tracking-tight text-gray-900 mb-3"}>{c.title}</h3>
